...
public static partial class TestAssemblyDependencyExtensions
{
    ...
    public static void AddTestAssemblyDependencies(this IServiceCollection services)
    {
        ...
        services.Add(new(typeof(InheritedCommonViewModelDoubledFactory), typeof(InheritedCommonViewModelDoubledFactory), Scoped));
        factory = static p => p.GetRequiredService(typeof(InheritedCommonViewModelDoubledFactory));
        services.Add(new(typeof(IInheritedCommonViewModelDoubledFactory), factory, Scoped));
        services.Add(new(typeof(IInheritedCommonFactory<InheritedCommonViewModelDoubled>), factory, Scoped));

        services.Add(new(typeof(InheritedCommonViewModelFactory), typeof(InheritedCommonViewModelFactory), Scoped));
        factory = static p => p.GetRequiredService(typeof(InheritedCommonViewModelFactory));
        services.Add(new(typeof(IInheritedCommonViewModelFactory), factory, Scoped));
        services.Add(new(typeof(IInheritedCommonFactory<InheritedCommonViewModel>), factory, Scoped));
    }
