...
public static partial class TestAssemblyDependencyExtensions
{
    ...
    public static void AddTestAssemblyDependencies(this IServiceCollection services)
    {
        ...
        services.Add(new(typeof(CommonViewModelDoubledFactory), typeof(CommonViewModelDoubledFactory), Scoped));
        factory = static p => p.GetRequiredService(typeof(CommonViewModelDoubledFactory));
        services.Add(new(typeof(ICommonViewModelDoubledFactory), factory, Scoped));
        services.Add(new(typeof(ICommonFactory<CommonViewModelDoubled>), factory, Scoped));

        services.Add(new(typeof(CommonViewModelFactory), typeof(CommonViewModelFactory), Scoped));
        factory = static p => p.GetRequiredService(typeof(CommonViewModelFactory));
        services.Add(new(typeof(ICommonViewModelFactory), factory, Scoped));
        services.Add(new(typeof(ICommonFactory<CommonViewModel>), factory, Scoped));
    }
