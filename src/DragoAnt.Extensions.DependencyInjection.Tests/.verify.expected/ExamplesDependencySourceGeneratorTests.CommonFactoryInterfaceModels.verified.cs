...
public static partial class TestAssemblyDependencyExtensions
{
    ...
    public static void AddTestAssemblyDependencies(this IServiceCollection services)
    {
        ...
        services.Add(new ServiceDescriptor(typeof(CommonViewModelDoubledFactory), typeof(CommonViewModelDoubledFactory), Scoped));
        factory = static p => p.GetRequiredService<CommonViewModelDoubledFactory>();
        services.Add(new ServiceDescriptor(typeof(ICommonViewModelDoubledFactory), factory, Scoped));
        services.Add(new ServiceDescriptor(typeof(ICommonFactory<CommonViewModelDoubled>), factory, Scoped));

        services.Add(new ServiceDescriptor(typeof(CommonViewModelFactory), typeof(CommonViewModelFactory), Scoped));
        factory = static p => p.GetRequiredService<CommonViewModelFactory>();
        services.Add(new ServiceDescriptor(typeof(ICommonViewModelFactory), factory, Scoped));
        services.Add(new ServiceDescriptor(typeof(ICommonFactory<CommonViewModel>), factory, Scoped));
    }
