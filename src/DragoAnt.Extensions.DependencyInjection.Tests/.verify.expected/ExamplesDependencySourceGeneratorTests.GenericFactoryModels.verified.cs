...
public static partial class TestAssemblyDependencyExtensions
{
    ...
    public static void AddTestAssemblyDependencies(this IServiceCollection services)
    {
        ...
        services.Add(new(typeof(GenericViewModelFactory), typeof(GenericViewModelFactory), Scoped));
        factory = static p => p.GetRequiredService(typeof(GenericViewModelFactory));
        services.Add(new(typeof(IGenericViewModelFactory), factory, Scoped));
        services.Add(new(typeof(IGenericFactory), factory, Scoped));
    }
